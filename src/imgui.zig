...
pub const ImS8 = i8;
pub const ImGuiTableColumnIdx = ImS8; // cimgui.h:2519:10: warning: struct demoted to opaque type - has bitfield
...
pub const ImVector_ImWchar = struct_ImVector_ImWchar; // cimgui.h:1188:18: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiDir = c_int; // cimgui.h:2225:15: warning: struct demoted to opaque type - has bitfield
...
pub const ImS16 = c_short; // cimgui.h:1024:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiTableDrawChannelIdx = ImU8; // cimgui.h:2381:10: warning: struct demoted to opaque type - has bitfield
...
pub const ImU64 = u64; // cimgui.h:2417:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiStyle = struct_ImGuiStyle; // cimgui.h:1790:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiDockNodeFlags_ = extern enum(c_int) {
    None = 0,
    KeepAliveOnly = 1,
...
pub const ImGuiItemAddFlags_ = extern enum(c_int) {
    None = 0,
    Focusable = 1,
    _,
};
...
pub const ImGuiInputTextFlagsPrivate_ = extern enum(c_int) {
...
pub const ImGuiDockNodeFlagsPrivate_ = extern enum(c_int) {
...
pub const ImGuiDataAuthority_ = extern enum(c_int) {
    Auto,
    DockNode,
    Window,
    _,
...
pub const ImGuiDockNodeState = extern enum(c_int) {
    _Unknown,
...
pub const ImGuiWindowDockStyleCol = extern enum(c_int) {
    _Text,
    _Tab,
    _TabHovered,
    _TabActive,
...
const IMGUI_HAS_DOCK = @as(c_int, 1);
